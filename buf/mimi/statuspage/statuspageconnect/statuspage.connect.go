...
import (
	...
	http "net/http"
	strings "strings"
	statuspage "within.website/x/buf/mimi/statuspage"
)
...
var (
	updateServiceDescriptor    = statuspage.File_mimi_statuspage_statuspage_proto.Services().ByName("Update")
	updatePokeMethodDescriptor = updateServiceDescriptor.Methods().ByName("Poke")
)
...
func NewUpdateClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UpdateClient {
	...
	return &updateClient{
		poke: connect.NewClient[statuspage.StatusUpdate, emptypb.Empty](
			...
			connect.WithSchema(updatePokeMethodDescriptor),
