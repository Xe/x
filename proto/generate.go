...
//go:generate protoc --proto_path=. --go_out=./future-sight --go_opt=paths=source_relative --twirp_out=./future-sight --twirp_opt=paths=source_relative ./future-sight.proto
