...
//go:generate protoc --proto_path=. --go_out=./relayd --go_opt=paths=source_relative ./relayd.proto
//go:generate protoc --proto_path=. --go_out=./sanguisuga --go_opt=paths=source_relative --go-grpc_out=./sanguisuga --go-grpc_opt=paths=source_relative --twirp_out=./sanguisuga --twirp_opt=paths=source_relative ./sanguisuga.proto
