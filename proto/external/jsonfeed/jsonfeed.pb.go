...
var file_jsonfeed_proto_goTypes = []interface{}{
...
func file_jsonfeed_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_jsonfeed_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Feed); i {
			case 0:
				return &v.state
			case 1:
		...
		file_jsonfeed_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Author); i {
			case 0:
				return &v.state
			case 1:
		...
		file_jsonfeed_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Item); i {
			case 0:
				return &v.state
			case 1:
		...
		file_jsonfeed_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
