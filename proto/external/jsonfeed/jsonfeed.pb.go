...
const file_jsonfeed_proto_rawDesc = "" +
	"\n" +
	...
	"\x13duration_in_seconds\x18\x05 \x01(\x05R\x11durationInSecondsB*Z(within.website/x/proto/external/jsonfeedb\x06proto3"

var (
	file_jsonfeed_proto_rawDescOnce sync.Once
	file_jsonfeed_proto_rawDescData []byte
)

func file_jsonfeed_proto_rawDescGZIP() []byte {
	file_jsonfeed_proto_rawDescOnce.Do(func() {
		file_jsonfeed_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_jsonfeed_proto_rawDesc), len(file_jsonfeed_proto_rawDesc)))
	})
...
func file_jsonfeed_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_jsonfeed_proto_rawDesc), len(file_jsonfeed_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
