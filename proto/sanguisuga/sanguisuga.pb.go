...
var file_sanguisuga_proto_goTypes = []interface{}{
...
func file_sanguisuga_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sanguisuga_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Show); i {
			case 0:
				return &v.state
			case 1:
		...
		file_sanguisuga_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Shows); i {
			case 0:
				return &v.state
			case 1:
		...
		file_sanguisuga_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sanguisuga_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sanguisuga_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sanguisuga_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
