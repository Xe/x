...
const file_sanguisuga_proto_rawDesc = "" +
	"\n" +
	"\x10sanguisuga.proto\x12\x1bwithin.website.x.sanguisuga\x1a\x1bgoogle/protobuf/empty.proto\"S\n" +
	"\x04Show\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x1b\n" +
	"\tdisk_path\x18\x02 \x01(\tR\bdiskPath\x12\x18\n" +
	"\aquality\x18\x03 \x01(\tR\aquality\"@\n" +
	"\x05Shows\x127\n" +
	"\x05shows\x18\x01 \x03(\v2!.within.website.x.sanguisuga.ShowR\x05shows\"w\n" +
	"\bTVSnatch\x12\x1a\n" +
	"\bcategory\x18\x01 \x01(\tR\bcategory\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1c\n" +
	"\tfreeleech\x18\x03 \x01(\bR\tfreeleech\x12\x1d\n" +
	"\n" +
	"torrent_id\x18\x04 \x01(\tR\ttorrentId\"O\n" +
	"\n" +
	"TVSnatches\x12A\n" +
	"\bsnatches\x18\x01 \x03(\v2%.within.website.x.sanguisuga.TVSnatchR\bsnatches\"\xc4\x01\n" +
	...
	"\apack_id\x18\a \x01(\tR\x06packId\"U\n" +
	"\rAnimeSnatches\x12D\n" +
	"\bsnatches\x18\x01 \x03(\v2(.within.website.x.sanguisuga.AnimeSnatchR\bsnatches2\xa7\x02\n" +
	"\x02TV\x12D\n" +
	"\x04List\x12\x16.google.protobuf.Empty\x1a\".within.website.x.sanguisuga.Shows\"\x00\x12D\n" +
	"\x05Track\x12!.within.website.x.sanguisuga.Show\x1a\x16.google.protobuf.Empty\"\x00\x12F\n" +
	"\aUntrack\x12!.within.website.x.sanguisuga.Show\x1a\x16.google.protobuf.Empty\"\x00\x12M\n" +
	"\bSnatches\x12\x16.google.protobuf.Empty\x1a'.within.website.x.sanguisuga.TVSnatches\"\x002\xad\x02\n" +
	"\x05Anime\x12D\n" +
	"\x04List\x12\x16.google.protobuf.Empty\x1a\".within.website.x.sanguisuga.Shows\"\x00\x12D\n" +
	"\x05Track\x12!.within.website.x.sanguisuga.Show\x1a\x16.google.protobuf.Empty\"\x00\x12F\n" +
	"\aUntrack\x12!.within.website.x.sanguisuga.Show\x1a\x16.google.protobuf.Empty\"\x00\x12P\n" +
	"\bSnatches\x12\x16.google.protobuf.Empty\x1a*.within.website.x.sanguisuga.AnimeSnatches\"\x00B#Z!within.website/x/proto/sanguisugab\x06proto3"

var (
	file_sanguisuga_proto_rawDescOnce sync.Once
	file_sanguisuga_proto_rawDescData []byte
)

func file_sanguisuga_proto_rawDescGZIP() []byte {
	file_sanguisuga_proto_rawDescOnce.Do(func() {
		file_sanguisuga_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sanguisuga_proto_rawDesc), len(file_sanguisuga_proto_rawDesc)))
	})
...
func file_sanguisuga_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sanguisuga_proto_rawDesc), len(file_sanguisuga_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   2,
