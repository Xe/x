...
const (
	TV_List_FullMethodName     = "/within.website.x.sanguisuga.v1.TV/List"
	TV_Track_FullMethodName    = "/within.website.x.sanguisuga.v1.TV/Track"
	TV_Untrack_FullMethodName  = "/within.website.x.sanguisuga.v1.TV/Untrack"
	TV_Snatches_FullMethodName = "/within.website.x.sanguisuga.v1.TV/Snatches"
)
...
func (UnimplementedTVServer) Untrack(context.Context, *Show) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Untrack not implemented")
}
func (UnimplementedTVServer) Snatches(context.Context, *emptypb.Empty) (*TVSnatches, error) {
	return nil, status.Error(codes.Unimplemented, "method Snatches not implemented")
}
...
func RegisterTVServer(s grpc.ServiceRegistrar, srv TVServer) {
	// If the following call panics, it indicates UnimplementedTVServer was
...
var TV_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "within.website.x.sanguisuga.v1.TV",
	...
	Metadata: "within/website/x/sanguisuga/v1/sanguisuga.proto",
}

const (
	Anime_List_FullMethodName     = "/within.website.x.sanguisuga.v1.Anime/List"
	Anime_Track_FullMethodName    = "/within.website.x.sanguisuga.v1.Anime/Track"
	Anime_Untrack_FullMethodName  = "/within.website.x.sanguisuga.v1.Anime/Untrack"
	Anime_Snatches_FullMethodName = "/within.website.x.sanguisuga.v1.Anime/Snatches"
)
...
func RegisterAnimeServer(s grpc.ServiceRegistrar, srv AnimeServer) {
	// If the following call panics, it indicates UnimplementedAnimeServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
var Anime_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "within.website.x.sanguisuga.v1.Anime",
