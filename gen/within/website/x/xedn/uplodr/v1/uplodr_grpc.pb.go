...
const (
	Image_Ping_FullMethodName   = "/within.website.x.xedn.uplodr.v1.Image/Ping"
	Image_Upload_FullMethodName = "/within.website.x.xedn.uplodr.v1.Image/Upload"
	Image_Stream_FullMethodName = "/within.website.x.xedn.uplodr.v1.Image/Stream"
)
...
var Image_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "within.website.x.xedn.uplodr.v1.Image",
	...
	Metadata: "within/website/x/xedn/uplodr/v1/uplodr.proto",
}
