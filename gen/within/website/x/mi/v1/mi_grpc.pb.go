...
const (
	SwitchTracker_Members_FullMethodName      = "/within.website.x.mi.v1.SwitchTracker/Members"
	SwitchTracker_WhoIsFront_FullMethodName   = "/within.website.x.mi.v1.SwitchTracker/WhoIsFront"
	SwitchTracker_Switch_FullMethodName       = "/within.website.x.mi.v1.SwitchTracker/Switch"
	SwitchTracker_GetSwitch_FullMethodName    = "/within.website.x.mi.v1.SwitchTracker/GetSwitch"
	SwitchTracker_ListSwitches_FullMethodName = "/within.website.x.mi.v1.SwitchTracker/ListSwitches"
)
...
func (UnimplementedSwitchTrackerServer) WhoIsFront(context.Context, *emptypb.Empty) (*FrontChange, error) {
	return nil, status.Error(codes.Unimplemented, "method WhoIsFront not implemented")
}
...
func RegisterSwitchTrackerServer(s grpc.ServiceRegistrar, srv SwitchTrackerServer) {
	// If the following call panics, it indicates UnimplementedSwitchTrackerServer was
...
var SwitchTracker_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "within.website.x.mi.v1.SwitchTracker",
...
const (
	POSSE_RefreshBlog_FullMethodName = "/within.website.x.mi.v1.POSSE/RefreshBlog"
)
...
func (UnimplementedPOSSEServer) RefreshBlog(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method RefreshBlog not implemented")
}
...
func RegisterPOSSEServer(s grpc.ServiceRegistrar, srv POSSEServer) {
	// If the following call panics, it indicates UnimplementedPOSSEServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
var POSSE_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "within.website.x.mi.v1.POSSE",
...
const (
	...
	Events_Add_FullMethodName    = "/within.website.x.mi.v1.Events/Add"
	Events_Remove_FullMethodName = "/within.website.x.mi.v1.Events/Remove"
)
