...
// 	protoc        (unknown)
// source: within/website/x/external/jsonfeed/v1/jsonfeed.proto
...
func (x *Feed) Reset() {
	*x = Feed{}
	mi := &file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_msgTypes[0]
...
func (*Feed) Descriptor() ([]byte, []int) {
	return file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDescGZIP(), []int{0}
}
...
func (x *Author) Reset() {
	*x = Author{}
	mi := &file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Author) Descriptor() ([]byte, []int) {
	return file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDescGZIP(), []int{1}
}
...
func (x *Item) Reset() {
	*x = Item{}
	mi := &file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Item) Descriptor() ([]byte, []int) {
	return file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDescGZIP(), []int{2}
}
...
func (x *Attachment) Reset() {
	*x = Attachment{}
	mi := &file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Attachment) Descriptor() ([]byte, []int) {
	return file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDescGZIP(), []int{3}
}
...
var File_within_website_x_external_jsonfeed_v1_jsonfeed_proto protoreflect.FileDescriptor

const file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDesc = "" +
	"\n" +
	"4within/website/x/external/jsonfeed/v1/jsonfeed.proto\x12%within.website.x.external.jsonfeed.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x90\x03\n" +
	"\x04Feed\x12\x14\n" +
	...
	"\afavicon\x18\b \x01(\tR\afavicon\x12G\n" +
	"\aauthors\x18\t \x03(\v2-.within.website.x.external.jsonfeed.v1.AuthorR\aauthors\x12\x1a\n" +
	"\blanguage\x18\n" +
	" \x01(\tR\blanguage\x12\x18\n" +
	"\aexpired\x18\v \x01(\bR\aexpired\x12A\n" +
	"\x05items\x18\f \x03(\v2+.within.website.x.external.jsonfeed.v1.ItemR\x05items\"F\n" +
	"\x06Author\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x12\x16\n" +
	"\x06avatar\x18\x03 \x01(\tR\x06avatar\"\xcc\x04\n" +
	"\x04Item\x12\x0e\n" +
	...
	"\rdate_modified\x18\v \x01(\v2\x1a.google.protobuf.TimestampR\fdateModified\x12G\n" +
	"\aauthors\x18\f \x03(\v2-.within.website.x.external.jsonfeed.v1.AuthorR\aauthors\x12\x12\n" +
	"\x04tags\x18\r \x03(\tR\x04tags\x12\x1a\n" +
	"\blanguage\x18\x0e \x01(\tR\blanguage\x12S\n" +
	"\vattachments\x18\x0f \x03(\v21.within.website.x.external.jsonfeed.v1.AttachmentR\vattachments\"\xa5\x01\n" +
	"\n" +
	"Attachment\x12\x10\n" +
	...
	"\x13duration_in_seconds\x18\x05 \x01(\x05R\x11durationInSecondsB\xbc\x02\n" +
	")com.within.website.x.external.jsonfeed.v1B\rJsonfeedProtoP\x01ZEwithin.website/x/gen/within/website/x/external/jsonfeed/v1;jsonfeedv1\xa2\x02\x05WWXEJ\xaa\x02%Within.Website.X.External.Jsonfeed.V1\xca\x02%Within\\Website\\X\\External\\Jsonfeed\\V1\xe2\x021Within\\Website\\X\\External\\Jsonfeed\\V1\\GPBMetadata\xea\x02*Within::Website::X::External::Jsonfeed::V1b\x06proto3"

var (
	file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDescOnce sync.Once
	file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDescData []byte
)

func file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDescGZIP() []byte {
	file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDescOnce.Do(func() {
		file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDesc), len(file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDesc)))
	})
	return file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDescData
}

var file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_goTypes = []any{
	(*Feed)(nil),                  // 0: within.website.x.external.jsonfeed.v1.Feed
	(*Author)(nil),                // 1: within.website.x.external.jsonfeed.v1.Author
	(*Item)(nil),                  // 2: within.website.x.external.jsonfeed.v1.Item
	(*Attachment)(nil),            // 3: within.website.x.external.jsonfeed.v1.Attachment
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_depIdxs = []int32{
	1, // 0: within.website.x.external.jsonfeed.v1.Feed.authors:type_name -> within.website.x.external.jsonfeed.v1.Author
	2, // 1: within.website.x.external.jsonfeed.v1.Feed.items:type_name -> within.website.x.external.jsonfeed.v1.Item
	4, // 2: within.website.x.external.jsonfeed.v1.Item.date_published:type_name -> google.protobuf.Timestamp
	4, // 3: within.website.x.external.jsonfeed.v1.Item.date_modified:type_name -> google.protobuf.Timestamp
	1, // 4: within.website.x.external.jsonfeed.v1.Item.authors:type_name -> within.website.x.external.jsonfeed.v1.Author
	3, // 5: within.website.x.external.jsonfeed.v1.Item.attachments:type_name -> within.website.x.external.jsonfeed.v1.Attachment
...
func init() { file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_init() }
func file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_init() {
	if File_within_website_x_external_jsonfeed_v1_jsonfeed_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDesc), len(file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_goTypes,
		DependencyIndexes: file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_depIdxs,
		MessageInfos:      file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_msgTypes,
	}.Build()
	File_within_website_x_external_jsonfeed_v1_jsonfeed_proto = out.File
	file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_goTypes = nil
	file_within_website_x_external_jsonfeed_v1_jsonfeed_proto_depIdxs = nil
}
