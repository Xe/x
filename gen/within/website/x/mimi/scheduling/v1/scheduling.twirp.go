...
func NewSchedulingProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Scheduling {
	...
	serviceURL += baseServicePath(pathPrefix, "within.website.x.mimi.scheduling.v1", "Scheduling")
	urls := [1]string{
...
func (c *schedulingProtobufClient) ParseEmail(ctx context.Context, in *ParseReq) (*ParseResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "within.website.x.mimi.scheduling.v1")
...
const SchedulingPathPrefix = "/twirp/within.website.x.mimi.scheduling.v1.Scheduling/"
...
func (s *schedulingServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "within.website.x.mimi.scheduling.v1.Scheduling" {
...
func (s *schedulingServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "within.website.x.mimi.scheduling.v1", "Scheduling")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
